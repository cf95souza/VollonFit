...
CREATE POLICY "Master teachers" ON gym_teachers FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "Master students" ON gym_students FOR ALL TO authenticated USING (true) WITH CHECK (true);
